...
# Print out one of the monster's powers to check
print("Monster's Power - Super Hearing Strength:", monster_powers["Super Hearing"])
...
#Q2: Roll the Monster's Magic Power
...
print(f"Monster's got {monster_power}, increasing their combat strength to: {m_combat_strength}")
...
#Q7: Organizing the loot more loot
belt.sort()
print(f"You have {belt}")
